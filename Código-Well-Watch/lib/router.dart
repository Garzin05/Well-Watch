...
import 'package:projetowell/screens/main.dart' as main_screens;
...
Map<String, WidgetBuilder> appRoutes() {
  return {
    ...
    AppRoutes.patientRegistration: (context) => const auth_screens.PatientRegistrationScreen(),
    AppRoutes.doctorRegistration: (context) => const auth_screens.DoctorRegistrationScreen(),
