...
import '../pages/calendar_base_page.dart';
              ...
              children: [
                ...
                CustomTextField(
                  ...
                  validator: (value) {
                    ...
                    // Validação básica de formato de hora
...
class WeightDataDisplay extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Para mostrar a evolução de peso, obtém os últimos registros
    ...
    // Calcula a variação de peso, se houver ao menos 2 registros
    double? weightChange;
    String? changeText;
            ...
            children: todayRecords.map((record) {
              return Container(
                ...
                decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.circular(8),
                  border: Border.all(
                    color: AppColors.darkBlueBackground.withOpacity(0.3),
                    width: 2,
                  ),
                ),
                child: Row(
