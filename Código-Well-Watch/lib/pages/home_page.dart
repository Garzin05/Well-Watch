  ...
  Widget _buildNavItem(int index, IconData icon, String label) {
    ...
    return GestureDetector(
      onTap: () {
        ...
        // Funcionalidade de navegação para desenvolvimento futuro
        if (index != 1) {
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            label,
            style: TextStyle(
              color: isSelected ? AppColors. : Colors.grey,
              fontSize: 12,
