...
class _WeightPageState extends State<WeightPage> {
  ...
  void _handlePatientSelected(Patient patient) {
    ...
    _loadWeightMeasurements(patient.id);
  }

  Future<void> _loadWeightMeasurements(String patientId) async {
    try {
      final measurements = await ApiService.getWeightMeasurements(patientId);
        ...
        setState(() {
          if (_selectedPatient != null) {
            _selectedPatient = Patient(
              ...
              records: [
                ..._selectedPatient!.records.where((r) => r.weightKg == null),
                ...measurements,
              ],
            );
          }
      ...
      debugPrint('[WeightPage] Erro ao carregar medições: $e');
    }
  }
